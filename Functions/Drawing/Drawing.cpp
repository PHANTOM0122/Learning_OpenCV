...
void drawLines() {
	Mat img(400, 400, CV_8UC3, Scalar(255, 255, 255)); // Initailize with white color

	line(img, Point(50, 50), Point(200, 50), Scalar(0, 0, 255)); // Red line
	line(img, Point(50, 100), Point(200, 100), Scalar(255, 0, 255), 3); // Purple line with thickness 3
	line(img, Point(50, 150), Point(200, 150), Scalar(255, 0, 0), 10); // Blue line with thickness 3
